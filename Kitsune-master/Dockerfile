FROM node:20-alpine AS baseLABEL org.opencontainers.image.title="4RB ANIME" \
  ...
  org.opencontainers.image.vendor="4rb-anime.com". Install dependencies only when needed
FROM base AS deps
